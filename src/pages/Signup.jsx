...
export default function Signup() {
    ...
    const { signUp, isSigningUp, handleGoogleSignIn } = useContext(AuthContext);
    ...
    return (
        <div className='flex flex-col md:flex-row w-full bg-white rounded-3xl shadow-2xl overflow-hidden mb-32' data-aos='flip-right'>
            {/* Left Side - Banner */}
            ...
            {/* Right Side - Form */}
            <div className='w-full md:w-1/2 flex flex-col justify-center items-center px-8 pt-8 pb-16'>
                <h2 className='text-4xl font-bold text-gray-800 mb-4'>SignUp</h2>
                <p className='text-gray-500 mb-8 text-start max-w-sm'>Get Started, Create a fee account</p>
                ...
                <p className='text-center mt-6 text-gray-500'>
                    Alreeady have an account? <Link to='/login' className='text-primary font-semibold'>login</Link>
                </p>
            </div>
        </div>
    );
